...
result = read_query(connection, "SELECT * FROM `breast-cancer`")
print(result)
...
with connection.cursor() as cursor:
    cursor.execute("USE `ag002`")
    cursor.execute("SELECT * FROM `breast-cancer`")
    dados = cursor.fetchall()

# Creating a DataFrame with the obtained data

df = pd.DataFrame(dados, columns=['id', 'age', 'menopause', 'tumor-size', 'inv-nodes', 'node-caps', 'deg-malig',
